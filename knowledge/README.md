...
- `releasing.md` — how versioned releases work (release-please).

The board and roadmap live in `../roadmap/`: `ROADMAP.md` (the source of truth for
cross-spec status), `BACKLOG.md` (the idea pool), and per-feature requirements,
design, and tasks in `specs/` — see `../roadmap/specs/README.md` for the format.
