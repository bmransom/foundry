...
| review-convergence | review-convergence: severity-gate `spec-review` (blocking/advisory), blind re-review, objective prose → a deterministic linter; closes the primed-`CLEAN` COE | Planned — spec drafted (`roadmap/specs/review-convergence/`); design pending approval | `roadmap/specs/review-convergence/` | code-review |
