...
**Status:** Spec — tasks drafted (2026-06-13) — tracked on the [board](../../ROADMAP.md).
...
- [ ] T10: Glossary — `knowledge/glossary.md`. Add *arm*, *context recall*, *gold span*, *context cost* with prior-art provenance; *decoy* already present. [design §Glossary additions · naming rule]
