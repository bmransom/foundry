...
**Status:** Spec — design drafted (2026-06-13) — tracked on the [board](../../docs/ROADMAP.md).
...
| Fixture | `evals/fixtures/navigation/` | `tree/` (docs/specs at ≈100/500/2000 lines w/ gold + decoy sections), `tasks.json`, `answer-key.json` |
...
{ "fixture": "navigation",
  "tasks": [
    { "id": "T1", "question": "...", "doc": "docs/big.md",
      "gold_spans": [{ "file": "docs/big.md", "heading": "Retry policy" }],
...
Recorded in `docs/glossary.md`: **arm** (experimental design / A-B testing); **context
